...
@JdbcTest
@Import({UserDbStorage.class, FilmDbStorage.class, ReviewDbStorage.class, DirectorDbStorage.class, FilmRowMapper.class, GenreRowMapper.class, UserRowMapper.class, DirectorRowMapper.class, EventRowMapper.class, ReviewRowMapper.class, UserService.class, ReviewService.class})
...
class FilmorateApplicationTests {
    ...
    void testCreateReview() {
        ...
        Review created = reviewService.create(newReview);
        ...
        assertThat(created.getFilmId()).isEqualTo(1L);
        assertThat(created.getUseful()).isEqualTo(0);
    }

    //Создание отзыва с несуществующим userId
    @Test
    void testCreateReview_userNotFound() {
        ...
        assertThatThrownBy(() -> reviewService.create(newReview))
            .isInstanceOf(NotFoundException.class)
            .hasMessageContaining("не найден");
    }
    ...
    void testUpdateReview() {
        ...
        assertThat(updated.getContent()).isEqualTo("Обновлённый фильм");
    ...
    void testUpdateReview_notFound() {
        ...
        assertThatThrownBy(() -> reviewService.update(reviewToUpdate))
            .isInstanceOf(NotFoundException.class)
            .hasMessageContaining("не найден");
    }
    ...
    void testAddLikeToReview() {
        ...
        reviewService.addLike(created.getReviewId(), 2L);

        Review updatedReview = reviewService.getById(created.getReviewId());
    ...
    void testAddDislikeToReview() {
        ...
        reviewService.addDislike(created.getReviewId(), 3L);
